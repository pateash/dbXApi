...
public class RejectedExceptionBean {
	...
	public RejectedExceptionBean() {
		super();
	}

	public RejectedExceptionBean(Integer id, Date timeGenerated, String source, String category, String description,
